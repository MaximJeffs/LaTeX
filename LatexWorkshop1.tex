...
\item And, of course, come along to the other \LaTeX\ workshops that we will be running later in the semester! The next one will be in week 5 on Thursday from 4-5 pm in CRISP G018. The source files for this workshop and the next are available on GitHub at \verb$https://github.com/MaximJeffs/LaTeX$.
\end{itemize}
